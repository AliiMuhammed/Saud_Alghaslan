...
const SaudCarousel = publicWidget.Widget.extend({
    ...
    cssLibs: [
        "/theme_saud/static/lib/OwlCarousel/dist/assets/owl.carousel.min.css",
        "/theme_saud/static/lib/OwlCarousel/dist/assets/owl.theme.default.min.css",
    ],
    jsLibs: [
